var playerTurn, moves, isGameOver, span, restartButton, turnIndicator, playerXScore, playerOScore;
playerTurn = "x";
moves = 0;
isGameOver = false;
...
function updateTurnIndicator() {
    turnIndicator.innerText = `Player ${playerTurn.toUpperCase()}'s turn`;
}
...
function gameOver(a) {
    var gameOverAlertElement = "<b>GAME OVER </b><br><br> Player " + playerTurn.toUpperCase() + ' Win !!! <br><br>' + restartButton;
